...
public interface Employee {
	...
	*/
	...
	public default void startUpBonus(){
		System.out.println("We will give bonus everybody");

	}
	public static void housing(){
		System.out.println("Valid ID holder get some discount");
	}

	double calculateEmployeeYearlyBonus(double monthlySalary, int performance);
